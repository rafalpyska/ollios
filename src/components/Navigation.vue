  ...
  <header class="header">
    <nav class="navigation">
      <ul class="navigation__list">
		...
		<path d="M489.573,427.178L365.638,303.242l-62.395,62.395l123.936,123.935c2.597,2.597,6.805,2.597,9.403,0l52.992-52.992
			C492.17,433.984,492.17,429.776,489.573,427.178z"/>
		<path d="M349.145,286.75l-21.654-21.654c-2.597-2.597-6.806-2.597-9.403,0l-9.794,9.794l-17.223-17.222
